...
<p><strong>Publicado por:</strong> <?= htmlspecialchars($postagem['autor_id']) ?> | 
...
<?php if (!empty($comentarios)): ?>
    <?php foreach ($comentarios as $comentario): ?>
        <div style="margin-bottom: 15px; padding: 10px; border-left: 3px solid #ccc;">
            <p><strong><?= htmlspecialchars($comentario['autor']) ?></strong> comentou em <?= date('d/m/Y H:i', strtotime($comentario['data_comentario'])) ?>:</p>
